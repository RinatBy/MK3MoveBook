window.MOVEBOOK_SEGA_MOVES = {
  ...
  "cyrax": {
    "Special Moves": [
      ...
      {"label":"Grenade-far","notation":"hold LK,_6,_6,HK,release LK","pretty":"hold LK,→,→,HK,release LK"},
      {"label":"Grenade-close","notation":"hold LK,_4,_4,HK,release LK","pretty":"hold LK,←,←,HK,release LK"},
      {"label":"Teleport","notation":"_6,_2,BL","pretty":"→,↓,BL"},
      {"label":"Air Throw                foe in air","notation":"_2,_6,BL to fly,LP to Throw","pretty":"↓,→,BL to fly,LP to Throw"}
    ],
    "Finishing Moves": [
    ...
    "Autokombos": [
      ...
      {"label":"(19%)","notation":"HK,HK,_4_+HK","pretty":"HK,HK,←+HK"},
  ...
  "ermac": {
    ...
    "Autokombos": [
      {"label":"(19%)","notation":"HP,HP,_4_+LP,_2,_6,LP","pretty":"HP,HP,←+LP,↓,→,LP"},
      {"label":"(23%)","notation":"HK,HK,LK,_4_+HK","pretty":"HK,HK,LK,←+HK"},
      {"label":"(24%)","notation":"HP,HP,_4_+LP,HK,_6_+LK","pretty":"HP,HP,←+LP,HK,→+LK"}
    ]
  },
  "jade": {
    "Special Moves": [
  ...
  "jax": {
    "Special Moves": [
      ...
      {"label":"Gotcha Grab","notation":"_6,_6,LP","pretty":"→,→,LP"},
      {"label":"Quad Slam","notation":"Throw","pretty":"Throw"},
      {"label":"Ground Smash","notation":"hold LK for a few seconds,then release","pretty":"hold LK for a few seconds,then release"},
    ...
    "Autokombos": [
      {"label":"(19%)","notation":"HK,HK,_4_+HK","pretty":"HK,HK,←+HK"},
      {"label":"(22%)","notation":"HP,HP,BL,LP","pretty":"HP,HP,BL,LP"},
      {"label":"(24%)","notation":"HP,HP,BL,LP,_4_+HP","pretty":"HP,HP,BL,LP,←+HP"},
      {"label":"(31%)","notation":"HK,HK,hold _2,HP,HP,BL,LP","pretty":"HK,HK,hold ↓,HP,HP,BL,LP"},
      {"label":"(33%)","notation":"HK,HK,hold _2,HP,HP,BL,LP,_4_+HP","pretty":"HK,HK,hold ↓,HP,HP,BL,LP,←+HP"}
    ]
  },
  "kabal": {
    "Special Moves": [
    ...
    "Autokombos": [
      {"label":"(18%)","notation":"HP,HP,_2_+HP(juggle)","pretty":"HP,HP,↓+HP(juggle)"},
      {"label":"(18%)","notation":"LK,LK,_4_+HK","pretty":"LK,LK,←+HK"},
      {"label":"(17%)","notation":"HP,HP,_2_+LP,_2_+HP","pretty":"HP,HP,↓+LP,↓+HP"},
      {"label":"(19%)","notation":"HP,HP,HK,_4_+HK","pretty":"HP,HP,HK,←+HK"},
      {"label":"(24%)","notation":"LK,LK,HK,_4_+HK","pretty":"LK,LK,HK,←+HK"},
      {"label":"(15%)","notation":"LK,LK,HP,HP,_2_+HP(juggle)","pretty":"LK,LK,HP,HP,↓+HP(juggle)"},
      {"label":"(17%)","notation":"LK,LK,HP,HP,_2_+LP,_2_+HP","pretty":"LK,LK,HP,HP,↓+LP,↓+HP"},
      {"label":"(18%)","notation":"LK,LK,HP,HP,HK,_4_+HK","pretty":"LK,LK,HP,HP,HK,←+HK"}
    ]
  },
  "kano": {
    "Special Moves": [
    ...
    "Autokombos": [
      {"label":"(15%)","notation":"LK,LP","pretty":"LK,LP"},
      {"label":"(18%)","notation":"LK,_2_+LP,_2_+HP","pretty":"LK,↓+LP,↓+HP"},
      {"label":"(18%)","notation":"HP,HP,_2_+HP","pretty":"HP,HP,↓+HP"},
      {"label":"(22%)","notation":"HP,HP,_2_+LP,_2_+HP","pretty":"HP,HP,↓+LP,↓+HP"},
      {"label":"(23%)","notation":"HK,HK,LK,_4_+HK","pretty":"HK,HK,LK,←+HK"},
  ...
  "kung-lao": {
    ...
    "Autokombos": [
      {"label":"(19%)","notation":"LK,LK,_4_+HK","pretty":"LK,LK,←+HK"},
      {"label":"(22%)","notation":"HP,LP,HP,LP","pretty":"HP,LP,HP,LP"},
      {"label":"(34%)","notation":"HP,LP,HP,LP,LK,LK,_4_+HK","pretty":"HP,LP,HP,LP,LK,LK,←+HK"}
    ]
  },
  "liu-kang": {
    "Special Moves": [
      ...
      {"label":"Fireball-high (also in air)","notation":"_8,_6,_6,HP","pretty":"↑,→,→,HP"},
      {"label":"Flying Kick","notation":"_6,_6,HK","pretty":"→,→,HK"},
      {"label":"Bicycle Kick","notation":"hold LK for five seconds,release","pretty":"hold LK for five seconds,release"}
    ],
    "Finishing Moves": [
      ...
      {"label":"Brutality","notation":"HP,LP,HP,BL,LK,HK,HK,LK,HK,LP,HP","pretty":"HP,LP,HP,BL,LK,HK,HK,LK,HK,LP,HP"}
    ],
    "Autokombos": [
      {"label":"(13%)","notation":"HP,HP,_4_+LP","pretty":"HP,HP,←+LP"},
      {"label":"(22%)","notation":"LK,LK,HK,LK","pretty":"LK,LK,HK,LK"},
      {"label":"(25%)","notation":"HP,LK,LK,HK,LK","pretty":"HP,LK,LK,HK,LK"},
      {"label":"(29%)","notation":"HP,HP,BL,LK,HK,LK,HK","pretty":"HP,HP,BL,LK,HK,LK,HK"}
    ]
  },
  "mileena": {
    "Special Moves": [
      {"label":"Sai Throw (also in air)","notation":"hold HP for 2 seconds,release","pretty":"hold HP for 2 seconds,release"},
      {"label":"Teleport Kick","notation":"_6,_6,LK","pretty":"→,→,LK"},
      {"label":"Ground Roll","notation":"_4,_4,_2,HK","pretty":"←,←,↓,HK"}
    ],
    "Finishing Moves": [
      {"label":"Fatality 1                 (far)","notation":"_2,_6,_2,_6,LK","pretty":"↓,→,↓,→,LK"},
    ...
    "Autokombos": [
      {"label":"(16%)","notation":"HK,HK,_2,_6,LK","pretty":"HK,HK,↓,→,LK"},
      {"label":"(22%)","notation":"HP,HP,_8_+LP,_2_+HP","pretty":"HP,HP,↑+LP,↓+HP"},
      {"label":"(23%)","notation":"HK,HK,_8_+LK,_2_+HK","pretty":"HK,HK,↑+LK,↓+HK"},
      {"label":"(24%)","notation":"HP,HP,HK,HK,_2,_6,LK","pretty":"HP,HP,HK,HK,↓,→,LK"},
      {"label":"(30%)","notation":"HP,HP,HK,HK,_8_+LK,_8_+HK","pretty":"HP,HP,HK,HK,↑+LK,↑+HK"}
    ]
  },
  "motaro": {
    "Special Moves": [
      {"label":"Fireball:","notation":"_2,_4,HP","pretty":"↓,←,HP"},
      {"label":"Teleport:","notation":"_2,_8","pretty":"↓,↑"},
      {"label":"Grab And Smash:","notation":"_6,_6,LP","pretty":"→,→,LP"},
      {"label":"Punch","notation":"HP or LP","pretty":"HP or LP"},
      {"label":"Donkey Kick","notation":"HK or LK","pretty":"HK or LK"}
    ]
  },
  "nightwolf": {
    "Special Moves": [
    ...
    "Autokombos": [
      {"label":"(19%)","notation":"HK,HK,_4_+HK","pretty":"HK,HK,←+HK"},
      {"label":"(21%)","notation":"HP,HP,LP,LP","pretty":"HP,HP,LP,LP"},
      {"label":"(22%)","notation":"HP,HP,LP,_4_+HK","pretty":"HP,HP,LP,←+HK"},
      {"label":"(27%)","notation":"LK,HP,HP,LP,_4_+HK","pretty":"LK,HP,HP,LP,←+HK"}
    ]
  },
  "noob-saibot": {
    "Special Moves": [
      {"label":"Disabler","notation":"_2,_6,LP","pretty":"↓,→,LP"},
      {"label":"Teleport","notation":"_2,_8","pretty":"↓,↑"},
      {"label":"Shadow Throw","notation":"_6,_6,HP","pretty":"→,→,HP"}
    ],
    "Finishing Moves": [
      {"label":"Brutality","notation":"HP,LK,LP,BL,LK,HK,HP,LP,BL,LK,HK","pretty":"HP,LK,LP,BL,LK,HK,HP,LP,BL,LK,HK"}
    ],
    "Autokombos": [
      {"label":"(22%)","notation":"HP,HP,LP,HK","pretty":"HP,HP,LP,HK"},
      {"label":"(23%)","notation":"LK,LK,LK,LK","pretty":"LK,LK,LK,LK"}
    ]
  },
  "rain": {
    "Special Moves": [
      {"label":"Orb","notation":"_2,_6,HP,_2,pad to control opponent","pretty":"↓,→,HP,↓,pad to control opponent"},
    ...
    "Autokombos": [
      {"label":"(21%)","notation":"HK,HK,LP,HP","pretty":"HK,HK,LP,HP"},
      {"label":"(22%)","notation":"HP,HP,LP,HP","pretty":"HP,HP,LP,HP"},
      {"label":"(24%)","notation":"HK,HK,LK,HK,_4_+HK","pretty":"HK,HK,LK,HK,←+HK"}
    ]
  },
  "reptile": {
    "Special Moves": [
      ...
      {"label":"Invisibility","notation":"hold BL,_8,_2,HK","pretty":"hold BL,↑,↓,HK"},
      {"label":"Slide","notation":"_4_+LP_+BL_+LK","pretty":"←+LP+BL+LK"}
    ],
    "Finishing Moves": [
    ...
    "Autokombos": [
      {"label":"(18%)","notation":"HP,HP,_2_+LP","pretty":"HP,HP,↓+LP"},
      {"label":"(21%)","notation":"HK,HK,_4_+HK","pretty":"HK,HK,←+HK"},
  ...
  "scorpion": {
    ...
    "Autokombos": [
      ...
      {"label":"(23%)","notation":"HK,HK,LK,LK","pretty":"HK,HK,LK,LK"},
      {"label":"(24%)","notation":"HP,HP,HK,_4_+HK","pretty":"HP,HP,HK,←+HK"}
    ]
  },
  "sektor": {
    "Special Moves": [
      ...
      {"label":"Homing Missile","notation":"_2,_4,HP","pretty":"↓,←,HP"}
    ],
    "Finishing Moves": [
    ...
    "Autokombos": [
      {"label":"(15%)","notation":"HK,HK","pretty":"HK,HK"},
      {"label":"(18%)","notation":"HP,HP,_2_+LP","pretty":"HP,HP,↓+LP"},
  ...
  "shang-tsung": {
    ...
    "Morphs": [
      ...
      {"label":"Liu Kang","notation":"360","pretty":"360"},
      ...
      {"label":"Robot Smoke","notation":"_6,_6,LP","pretty":"→,→,LP"},
  ...
  "shao-kahn": {
    "Special Moves": [
      ...
      {"label":"Slam:","notation":"_6,_6,LP","pretty":"→,→,LP"},
      {"label":"Upper Slam:","notation":"_6,_6,HP","pretty":"→,→,HP"},
  ...
  "sindel": {
    ...
    "Autokombos": [
      {"label":"(18%)","notation":"HP,HP,_2_+HP","pretty":"HP,HP,↓+HP"},
      {"label":"(19%)","notation":"HK,HK,_4_+HK","pretty":"HK,HK,←+HK"},
      {"label":"(25%)","notation":"HP,HP,LP,_4_+HK","pretty":"HP,HP,LP,←+HK"},
      {"label":"(33%)","notation":"LK,HP,HP,LP,_4_+HK","pretty":"LK,HP,HP,LP,←+HK"}
    ]
  },
  "robot-smoke": {
    "Special Moves": [
    ...
    "Finishing Moves": [
      ...
      {"label":"Brutality","notation":"HP,LK,LK,HK,BL,BL,LP,LP,HP,HP,BL,BL","pretty":"HP,LK,LK,HK,BL,BL,LP,LP,HP,HP,BL,BL"}
    ],
    "Autokombos": [
      {"label":"(18%)","notation":"HP,HP,LP","pretty":"HP,HP,LP"},
      {"label":"(18%)","notation":"HP,HP,HK","pretty":"HP,HP,HK"},
      {"label":"(19%)","notation":"HK,HK,LP","pretty":"HK,HK,LP"},
  ...
  "sonya": {
    ...
    "Autokombos": [
      {"label":"(18%)","notation":"HP,HP,_8_+LP","pretty":"HP,HP,↑+LP"},
      {"label":"(19%)","notation":"HK,HK,_4_+HK","pretty":"HK,HK,←+HK"},
      {"label":"(22%)","notation":"HP,HP,LK,_4_+HP","pretty":"HP,HP,LK,←+HP"},
      {"label":"(?%)","notation":"HK,HK,HP,HP,_8_+LP","pretty":"HK,HK,HP,HP,↑+LP"},
      {"label":"(31%)","notation":"HK,HK,HP,HP,LP,_4_+HP","pretty":"HK,HK,HP,HP,LP,←+HP"}
    ]
  },
  "stryker": {
    "Special Moves": [
    ...
    "Autokombos": [
      {"label":"(18%)","notation":"HP,HP,_6_+LP","pretty":"HP,HP,→+LP"},
      {"label":"(19%)","notation":"LK,LK,_4_+HK","pretty":"LK,LK,←+HK"},
      {"label":"(21%)","notation":"LK,LK,_4_+LP,_4_+HK","pretty":"LK,LK,←+LP,←+HK"},
      {"label":"(23%)","notation":"LK,HP,HP,_6_+LP","pretty":"LK,HP,HP,→+LP"}
    ]
  },
  "unmasked-sub-zero": {
    "Special Moves": [
      ...
      {"label":"Slide","notation":"_4_+LP_+LK_+BL","pretty":"←+LP+LK+BL"}
    ],
    "Finishing Moves": [
